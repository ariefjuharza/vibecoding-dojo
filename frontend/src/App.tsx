...
function App() {
  ...
  return (
    <>
      <Sakura />
      <div style={{ position: 'relative', zIndex: 10, display: 'flex', flexDirection: 'column', minHeight: '100vh', width: '100%' }}>
        ...
        <main className="container" style={{ flex: 1, width: '100%', display: 'flex', flexDirection: 'column' }}>
